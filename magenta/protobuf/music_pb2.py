...
_NOTESEQUENCE_NOTE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='chord_root', full_name='tensorflow.magenta.NoteSequence.Note.chord_root', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='chord_quality', full_name='tensorflow.magenta.NoteSequence.Note.chord_quality', index=15,
